...
struct VictoriaData_Landmarks {//48.504916774648024, 35.08895341534381
    ...
    static let landmarks: [VictoriaLandmark] = [
        ...
        VictoriaLandmark(latitude: 48.50501598291745, longitude: 35.08884350531226, name: "Miniature World", details: "Miniature-themed dioramas & displays representing historical times & fictional worlds."),
        ...
        VictoriaLandmark(latitude: 48.50501520439531, longitude: 35.08887130843918, name: "Cenotaph", details: nil),
